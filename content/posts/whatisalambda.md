...
{{< figure src="~/Pictures/whatsalambda/lambdaDefined.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/definingLambda.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/inspectLambda.png" width="1000px" >}}

... gives us some details.

{{< figure src="~/Pictures/whatsalambda/inspectLambda2.png" width="1000px" >}}

The CODE line looks interesting. Click it.

{{< figure src="~/Pictures/whatsalambda/disassembly.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/useAsterisk.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/funcallLambda.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/funcallPlus.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/mapcar.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/average.png" width="1000px" >}}

Here's one that rearranges the numbers.

{{< figure src="~/Pictures/whatsalambda/rearrange.png" width="1000px" >}}

Here's one that keeps a running total for each iteration.

{{< figure src="~/Pictures/whatsalambda/runningTotal.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/closure1.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/closure1.1.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/closure1.2.png" width="1000px" >}}

Well ... now what?

{{< figure src="~/Pictures/whatsalambda/closure1.3.png" width="1000px" >}}

This doesn't seem to be getting anywhere.

Wait! Assign the closure to a variable!

{{< figure src="~/Pictures/whatsalambda/closure2.png" width="1000px" >}}

Now use `funcall` on it.

{{< figure src="~/Pictures/whatsalambda/closure3.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/closure4.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/closure5.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/baseballPlayer.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/classPlayersDB.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/classPlayersDBAnnotated.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/classPlayersDB-firstmod.png" width="1000px" >}}

And the conditional would then become something like this:

{{< figure src="~/Pictures/whatsalambda/classPlayersDB-secondmod.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/classPlayersDB-thirdmod.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/moreAtBatsClass.png" width="1000px" >}}

So, how does it work? You add a test for it ...

{{< figure src="~/Pictures/whatsalambda/testerTest-zero.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/testerTest-first.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/testAnonymous-create.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/testAnonymous-create-2.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/testAnonymous-create-3.png" width="1000px" >}}

And you can also use local variables ... a local variable over an
anonymous class ...

{{< figure src="~/Pictures/whatsalambda/testAnonymous-create-4.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/lambda-1.png" width="1000px" >}}

And let's modify our `PlayersDB` and add the following method:

{{< figure src="~/Pictures/whatsalambda/lambda-2.png" width="1000px" >}}

Now, in test, we can "new up" our Lambda interface just like we did
with the abstract class and get an anonymous class.

{{< figure src="~/Pictures/whatsalambda/lambda-3.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/lambda-4.png" width="1000px" >}}

Wait. What??

Pressing enter ...

{{< figure src="~/Pictures/whatsalambda/lambda-5.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/lambda-6.png" width="1000px" >}}
...
{{< figure src="~/Pictures/whatsalambda/lambda-7.png" width="1000px" >}}

And there's nothing to stop us from using a local variable over the
lambda ...

{{< figure src="~/Pictures/whatsalambda/lambda-8.png" width="1000px" >}}
